...
class c20(commands.Cog, name="c20"):
    ...
    def __init__(self, bot: commands.Bot):
        self.bot = bot
    @commands.command(name='Varatora_Temporal_Justiciar', aliases=['c20','Temporal_11'])
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='During your Main Phase: You can target 1 face-up Pyro monster you control; it gains 1000 ATK until your next End Phase. During the Main Phase (Quick Effect): You can banish this card from your GY, then target 1 Pyro "Temporal" monster you control; apply its effect on the field. (The monster\'s activation requirements do not need to be correct). You can only activate each effect of "Varatora, Temporal Justiciar" once per turn.', inline=False)
