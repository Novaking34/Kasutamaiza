...
class c38(commands.Cog, name="c38"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='2+ Level 4 Beast monsters\nThis card gains 200 ATK/DEF for each material attached to this card. Once per turn, if a card is discarded from your hand by the effects of a "Hidden Treasure" monster, attach the discarded card to this card. Once per turn (Quick Effect): You can detach 2 materials from this card, then target 1 card on each field; return them to the hand.', inline=False)
