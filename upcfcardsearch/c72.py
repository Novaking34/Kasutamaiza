...
class c72(commands.Cog, name="c72"):

    def __init__(self, bot: commands.Bot):
        self.bot = bot
    @commands.command(name='An_Unexpected_Counter', aliases=['c72'])
    async def example_embed(self, ctx):
        embed = discord.Embed(title='An Unexpected Counter',
                              color=0x1D9E74)
        embed.set_thumbnail(url='https://www.duelingbook.com/images/custom-pics/2300000/2321493.jpg')
