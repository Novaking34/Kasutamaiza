...
class c4(commands.Cog, name="c4"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='2 Level 4 monsters\nIf a monster(s) you control is destroyed by a card effect: This card gains ATK equal to half the total original ATK of the destroyed monsters. If this card\'s attack is negated: You can detach 1 material; this card can make a second attack during the Battle Phase this turn.', inline=False)
