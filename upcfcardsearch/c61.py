...
class c61(commands.Cog, name="c61"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='When your opponent activates a Spell/Trap Card or effect (Quick Effect): You can discard this card; negate the activation, then, if you have 5 or more "Season &" monsters in your GY, destroy 1 Spell/Trap card on the field. Your opponent can discard 1 card of the same Type (Spell or Trap) to negate this card\'s effect.', inline=False)
