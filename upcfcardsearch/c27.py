...
class c27(commands.Cog, name="c27"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='You can reveal this card in your hand: your opponent randomly chooses 1 card from your entire hand, then you discard the chosen card. Then, if the discarded card was not "Hidden Treasure Jasper Armadillo", Special Summon 1 "Hidden Treasure Jasper Armadillo" from your hand, and if you have 2 or less cards in your hand, draw 1 card, also, for the rest of the turn, you cannot Special Summon monsters, except Beast monsters. If this card is discarded: Target cards on the field, up to the number of other "Hidden Treasure monsters in your GY (max. 2); destroy those targets. You can only use each effect of "Hidden Treasure Jasper Armadillo" once per turn.', inline=False)
