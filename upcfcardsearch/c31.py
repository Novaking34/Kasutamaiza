...
class c31(commands.Cog, name="c31"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Card Effect', value='Once per turn, during your Main Phase 2, if you discarded 2 or more "Hidden Treasure" monsters: You can add 1 "Hidden Treasure" monster from your GY to your hand. You can only control 1 "The Hidden Treasure Mining Site". If this card is discarded: You can take 3 "Hidden Treasure" cards from your GY, your opponent chooses 1 to add to your hand, then shuffle the rest back into your Deck. You must control 2 or more Beast monsters or a "Hidden Treasure" monster to activate and resolve this effect of "The Hidden Treasure Mining Site".', inline=False)
