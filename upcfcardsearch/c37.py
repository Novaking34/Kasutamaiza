...
class c37(commands.Cog, name="c37"):
    ...
    async def example_embed(self, ctx):
        ...
        embed.add_field(name='Monster Effect', value='2 Level 4 Beast monster\nIf this card is Xyz Summoned: Excavate the top card of your Deck and if it was a "Hidden Treasure" card, add it to your hand, otherwise, shuffle it back into your Deck, also, after that, shuffle up to 3 "Hidden Treasure" cards from your GY into your Deck. You can only Xyz Summon 1 "Hidden Treasure Sapphire Cat" per turn. Once per turn, if a card is discarded from your hand by the effects of a "Hidden Treasure" monster, you can attach the discarded card to this card. (Quick Effect): You can detach 1 material from this card; this turn, Beast monsters you control can attack directly, but all battle damage is halved.', inline=False)
